...
package net.mcreator.combatstyleexpansion.network;
...
import net.mcreator.combatstyleexpansion.CombatstyleexpansionMod;
...
public class TestMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CombatstyleexpansionMod.addNetworkMessage(TestMessage.class, TestMessage::buffer, TestMessage::new, TestMessage::handler);
	}
}
